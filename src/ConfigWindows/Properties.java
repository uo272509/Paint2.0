...
public class Properties extends javax.swing.JFrame {
    ...
    public Properties(MainWindow mw) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Background color", jPanel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        mainWindow.setPaintBackground(jColorChooser1.getColor());
        mainWindow.changeMade();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int chosen = JOptionPane.OK_OPTION;
        
        if(!jColorChooser1.getColor().equals(prevBgColor))
            chosen = JOptionPane.showConfirmDialog(this, "Are you sure you want to discard the changes?", "Discard?",
            JOptionPane.OK_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE, null);
        
        if(chosen == JOptionPane.OK_OPTION){
            mainWindow.setPaintBackground(prevBgColor);
    ...
    public void setLastBgColor(Color c){
        prevBgColor = c;
    }
